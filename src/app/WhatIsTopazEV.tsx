...
export default function WhatIsAddisEV() {
  ...
  return (
    <section className="w-full bg-background-main py-12 sm:py-16 md:py-20 lg:py-20 px-4 sm:px-6 md:px-8 lg:px-14">
        ...
        <div className="flex flex-col gap-0.5 items-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full px-4 sm:px-4 md:px-4 lg:px-4">
            {features.map((feature) => (
              <div
                key={feature.id}
                className="addisev-gradient-panel flex flex-col items-center gap-2.5 rounded-md border border-border-secondary p-5"
              >
                <Image
                  src={feature.icon}
                  alt={feature.title}
                ...
                <h3 className="text-lg font-bold leading-lg text-text-inverse text-center">
                  {feature.title}
                </h3>
