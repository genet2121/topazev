          ...
          <div className="flex flex-col lg:flex-row gap-8 sm:gap-10 md:gap-12 lg:gap-15 items-start lg:items-center">
            <div className="w-full lg:w-[42%] flex flex-col gap-10.5 sm:gap-10.5 md:gap-10.5 lg:gap-10.5 mt-0 lg:mt-10.5 px-5.5 sm:px-5.5 md:px-5.5 lg:px-5.5">
              ...
              <div className="flex flex-col sm:flex-row gap-3.5">
                <button className="rounded-2xl border border-button-border-primary bg-button-bg-primary px-7.5 py-3.5 text-sm font-semibold leading-sm text-button-text-primary transition-colors hover:opacity-90">
                  Get Demo Access
                </button>
                <button className="rounded-2xl border-medium border-button-border-primary bg-button-bg-secondary px-8 py-3.5 text-sm font-semibold leading-sm text-button-text-secondary transition-colors hover:bg-background-card">
                  View FAQ
                </button>
              </div>
            </div>
